...
\usepackage[alf]{abntex2cite}               % Pacote para utilizar a citação da abnt (Nome,ANO)
...
\chapter{INTRODUÇÃO}
    ...
    A proposta deste trabalho visa unir os programas livres em uma única plataforma. Essa será  construída para ser amigável, fazendo uso de uma GUI ({Graphical User Interface}\footnote{Interface Gráfica do Utilizador}) simples, agindo como intermediaria entre o usuário e os programas disponíveis no \index{MTnet}.
